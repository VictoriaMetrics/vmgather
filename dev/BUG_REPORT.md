...
23. [P2][TODO] CI "Docker Images (smoke)" doesn't build anything: `make docker-build PLATFORMS=linux/amd64` is a no-op (no recipes for `docker-build-vmgather` / `docker-build-vmimporter`). This is also true on `origin/main`.
